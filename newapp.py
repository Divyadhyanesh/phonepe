...
st.set_page_config(page_title="Phonepe Pulse Data Visualization | By Divya",
                    layout="wide",
                    initial_sidebar_state="expanded",
                    menu_items={'About': """# This dashboard app is created by *Divya*!
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_excel("C:\\Users\\hp\\Downloads\\indiastates.xlsx")
            df1.State = df2
